...
public class PerformanceTest {
    ...
    public void displayPerformanceAnalysis() throws IOException {
        ...
        runEncode("100KB Test", TestUtils.PERFORMANCE_1MB, TestUtils.ENCODE_PERFORMANCE_1MB_OUTPUT);
        ...
        runDecode("100KB Test", TestUtils.ENCODE_PERFORMANCE_1MB_OUTPUT, TestUtils.DECODE_PERFORMANCE_1MB_OUTPUT);
        runDecode("5MBB Test", TestUtils.ENCODE_PERFORMANCE_5MB_OUTPUT, TestUtils.DECODE_PERFORMANCE_5MB_OUTPUT);
